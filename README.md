...
* [van](https://github.com/vanjs-org/van) ⭐ 4,433 | 🐛 40 | 🌐 JavaScript | 📅 2026-07-16 - vDOM-based framework optimized for no-build setups, <img align="top" height="24" src="./img/vanjs-core.svg">
...
* [zustand](https://github.com/pmndrs/zustand) ⭐ 58,697 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-18 - Simple stores with pleasant actions and selectors. Vanilla <img align="top" height="24" src="./img/zustandvanilla.svg">, React <img align="top" height="24" src="./img/zustand.svg">
...
* [wouter](https://github.com/molefrog/wouter) ⭐ 7,895 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-14 - Declarative router for React / preact, <img align="top" height="24" src="./img/wouter.svg">, also available as a standalone hook: <img align="top" height="24" src="./img/wouteruse-browser-location.svg">
...
* [regexparam](https://github.com/lukeed/regexparam) ⭐ 598 | 🐛 9 | 🌐 JavaScript | 📅 2023-12-03 - Convert path to regexp in <img align="top" height="24" src="./img/regexparam.svg">
...
* [lingui](https://github.com/lingui/js-lingui) ⭐ 5,883 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-18 - Small core with template strings, <img align="top" height="24" src="./img/linguicore.svg">
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,668 | 🐛 1,333 | 🌐 JavaScript | 📅 2026-09-15 - *Almost* moment.js-compatible API, covers most use cases, <img align="top" height="24" src="./img/dayjsesm.svg">
* [date-fns](https://github.com/date-fns/date-fns/) ⭐ 36,645 | 🐛 1,014 | 🌐 TypeScript | 📅 2026-08-30 - Not tiny as a whole, but [most functions](https://bundlephobia.com/package/date-fns) are under 1 kB each (format and parse are quite heavy).

And some more packages that only do formatting:

* [ms](https://github.com/vercel/ms) ⭐ 5,552 | 🐛 38 | 🌐 TypeScript | 📅 2026-05-20 - Parse & format ms durations, e.g. `"1m" <-> 60000`, <img align="top" height="24" src="./img/ms.svg">
...
* [remeda](https://github.com/remeda/remeda) ⭐ 5,428 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-18 - 90 tree-shakable helpers [(list).](https://bundlephobia.com/package/remeda)
* [rambda](https://github.com/selfrefactor/rambda) ⭐ 1,758 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-03 - 187 tree-shakable helpers [(list).](https://bundlephobia.com/package/rambda)
...
* [valibot](https://github.com/fabian-hiller/valibot) ⭐ 9,015 | 🐛 184 | 🌐 TypeScript | 📅 2026-09-17 - Another modular validation library, <img align="top" height="24" src="./img/valibot.svg">
...
* [nanoid](https://github.com/ai/nanoid) ⭐ 26,977 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-16 - Random IDs with larger alphabet, <img align="top" height="24" src="./img/nanoid.svg">
