...
* [preact](https://github.com/preactjs/preact) ⭐ 38,858 | 🐛 42 | 🌐 JavaScript | 📅 2026-09-09 - React-like API (pre-hooks). Cool ecosystem of similarly tiny tools and components. Highly recommended. <img align="top" height="24" src="./img/preact.svg">
...
* [hyperapp](https://github.com/jorgebucaran/hyperapp) ⭐ 19,197 | 🐛 15 | 🌐 JavaScript | 📅 2025-03-20 - vDOM framework with pure JS syntax and immutable state, <img align="top" height="24" src="./img/hyperapp.svg">
...
* [van](https://github.com/vanjs-org/van) ⭐ 4,428 | 🐛 40 | 🌐 JavaScript | 📅 2026-07-16 - vDOM-based framework optimized for no-build setups, <img align="top" height="24" src="./img/vanjs-core.svg">
...
* [arrowjs](https://github.com/justin-schroeder/arrow-js) ⭐ 3,747 | 🐛 6 | 🌐 TypeScript | 📅 2026-07-01 - Tagged templates + reactive data, <img align="top" height="24" src="./img/arrow-jscore.svg">
...
* [mitt](https://github.com/developit/mitt) ⭐ 11,906 | 🐛 27 | 🌐 TypeScript | 📅 2024-08-14 - Plain event emitter that I use on most projects, <img align="top" height="24" src="./img/mitt.svg">
* [nanoevents](https://github.com/ai/nanoevents) ⭐ 1,633 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-22 - Nicer unsubscribe API, but no `*` event, <img align="top" height="24" src="./img/nanoevents.svg">
...
* [zustand](https://github.com/pmndrs/zustand) ⭐ 58,658 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-07 - Simple stores with pleasant actions and selectors. Vanilla <img align="top" height="24" src="./img/zustandvanilla.svg">, React <img align="top" height="24" src="./img/zustand.svg">
* [nanostores](https://github.com/nanostores/nanostores) ⭐ 7,598 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-08 - Modular store with good tree-shaking support, <img align="top" height="24" src="./img/nanostores.svg"> vanilla, + React <img align="top" height="24" src="./img/nanostoresreact.svg"> extra. Supports all the top frameworks.
...
* [exome](https://github.com/marcisbee/exome) ⭐ 282 | 🐛 1 | 🌐 TypeScript | 📅 2026-01-29 - Atomic stores with lots of framework connectors, <img align="top" height="24" src="./img/exome.svg"> + React <img align="top" height="24" src="./img/exomereact.svg"> extra. Supports all the top frameworks.

### Signals

A signal-styled state manager provides observable values (aka *signals*), derived values and effects.

* [@preact/signals](https://github.com/preactjs/signals) ⭐ 4,482 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-04 - The OG signals from preact <img align="top" height="24" src="./img/preactsignals-core.svg"> core, <img align="top" height="24" src="./img/preactsignals-react.svg"> with react integration.
...
* [wouter](https://github.com/molefrog/wouter) ⭐ 7,886 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-05 - Declarative router for React / preact, <img align="top" height="24" src="./img/wouter.svg">, also available as a standalone hook: <img align="top" height="24" src="./img/wouteruse-browser-location.svg">
...
* [wretch](https://github.com/elbywan/wretch) ⭐ 5,175 | 🐛 12 | 🌐 TypeScript | 📅 2026-06-19 - Chainable API with error processing and lots of extra plugins, <img align="top" height="24" src="./img/wretch.svg">
* [redaxios](https://github.com/developit/redaxios) ⭐ 4,879 | 🐛 34 | 🌐 JavaScript | 📅 2023-08-15 - Drop-in axios replacement for modern browsers, <img align="top" height="24" src="./img/redaxios.svg">
...
* [unfetch](https://github.com/developit/unfetch) ⭐ 5,697 | 🐛 30 | 🌐 JavaScript | 📅 2023-07-23 - Loose fetch polyfill, <img align="top" height="24" src="./img/unfetch.svg">

## I18N

A map of strings might seem enough to translate an app, but these tools also handle interpolation and some extra goodies:

* [lingui](https://github.com/lingui/js-lingui) ⭐ 5,873 | 🐛 70 | 🌐 TypeScript | 📅 2026-09-08 - Small core with template strings, <img align="top" height="24" src="./img/linguicore.svg">
* [rosetta](https://github.com/lukeed/rosetta) ⭐ 798 | 🐛 6 | 🌐 JavaScript | 📅 2024-01-20 - Bare-bones template strings (`{{hello}}, {{username}}`) and custom functions for everyting else, <img align="top" height="24" src="./img/rosetta.svg">
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,664 | 🐛 1,325 | 🌐 JavaScript | 📅 2026-09-09 - *Almost* moment.js-compatible API, covers most use cases, <img align="top" height="24" src="./img/dayjsesm.svg">
* [date-fns](https://github.com/date-fns/date-fns/) ⭐ 36,645 | 🐛 1,007 | 🌐 TypeScript | 📅 2026-08-30 - Not tiny as a whole, but [most functions](https://bundlephobia.com/package/date-fns) are under 1 kB each (format and parse are quite heavy).

And some more packages that only do formatting:

* [ms](https://github.com/vercel/ms) ⭐ 5,547 | 🐛 37 | 🌐 TypeScript | 📅 2026-05-20 - Parse & format ms durations, e.g. `"1m" <-> 60000`, <img align="top" height="24" src="./img/ms.svg">
* [timeago.js](https://github.com/hustcc/timeago.js) ⭐ 5,369 | 🐛 9 | 🌐 TypeScript | 📅 2026-06-30 - Format dates into stuff like *X minutes ago* or *in X hours,* <img align="top" height="24" src="./img/timeagojs.svg">
* [tinytime](https://github.com/aweary/tinytime) ⭐ 1,322 | 🐛 19 | 🌐 JavaScript | 📅 2023-01-12 - Simple date / time formatter: `{h}:{mm} -> 9:33`, <img align="top" height="24" src="./img/tinytime.svg">
...
* [time-stamp](https://github.com/jonschlinkert/time-stamp) ⭐ 109 | 🐛 8 | 🌐 JavaScript | 📅 2020-11-24 - More of the same, <img align="top" height="24" src="./img/time-stamp.svg">
...
* [just](https://github.com/angus-c/just) ⭐ 6,201 | 🐛 58 | 🌐 JavaScript | 📅 2024-02-11 - 82 helpers in separate packages [(list).](https://anguscroll.com/just/)
* [remeda](https://github.com/remeda/remeda) ⭐ 5,426 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-09 - 90 tree-shakable helpers [(list).](https://bundlephobia.com/package/remeda)
* [rambda](https://github.com/selfrefactor/rambda) ⭐ 1,755 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-03 - 187 tree-shakable helpers [(list).](https://bundlephobia.com/package/rambda)
* [@fxts/core](https://github.com/marpple/FxTS) ⭐ 1,166 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-29 - 96 tree-shakable helpers. Lazy evaluation support.

Honorable mention: [underscore,](https://github.com/jashkenas/underscore) ⭐ 27,323 | 🐛 52 | 🌐 JavaScript | 📅 2026-08-12 contains many sub-1 kB helpers. It does not tree-shake as well as the libraries above due to codebase structure.
...
* [valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,981 | 🐛 175 | 🌐 TypeScript | 📅 2026-09-09 - Another modular validation library, <img align="top" height="24" src="./img/valibot.svg">
* [superstruct](https://github.com/ianstormtaylor/superstruct) ⭐ 7,130 | 🐛 104 | 🌐 TypeScript | 📅 2024-10-01 - The most popular modular validation library with good tree-shaking, <img align="top" height="24" src="./img/superstruct.svg">
...
* [nanoid](https://github.com/ai/nanoid) ⭐ 26,964 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-01 - Random IDs with larger alphabet, <img align="top" height="24" src="./img/nanoid.svg">
...
* [colord](https://github.com/omgovich/colord) ⭐ 1,887 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-01 - Manipulate colors and convert between spaces, <img align="top" height="24" src="./img/colord.svg">. Extra features come as plugins, 150b to 1.5 kB each.
...
* [alloyfinger](https://github.com/AlloyTeam/AlloyFinger) ⭐ 3,436 | 🐛 77 | 🌐 JavaScript | 📅 2019-01-03 - Pan, swipe, tap, doubletap, longpress, *and* pinch / rotate. My personal favorite. <img align="top" height="24" src="./img/alloyfinger.svg">.
...
* [detect-it](https://github.com/rafgraph/detect-it) ⭐ 435 | 🐛 1 | 🌐 TypeScript | 📅 2021-05-02 - Detect present and primary input method (touch / mouse) and supported events, <img align="top" height="24" src="./img/detect-it.svg">
...
Honorable mentions: [any-touch](https://github.com/any86/any-touch) ⭐ 1,244 | 🐛 18 | 🌐 TypeScript | 📅 2026-01-09 attempts a modular approach to gesture detection, but the core is around 2 kB without any gesture recognizers. [rc-gesture,](https://github.com/react-component/gesture) ⭐ 104 | 🐛 15 | 🌐 TypeScript | 📅 2021-07-27 used in ant design system, could be the only react component on the list, but babel-runtime / corejs polyfills hard-wired into the build push the \~2.5 kB size to over 10 kB.
...
* [wade](https://github.com/kbrsh/wade) ⭐ 2,956 | 🐛 7 | 🌐 JavaScript | 📅 2023-05-13 - Also similar, [(compare)](https://leeoniya.github.io/uFuzzy/demos/compare.html?libs=js-search,Wade,ndx\&search=twilight%20sag) <img align="top" height="24" src="./img/wade.svg">
* [js-search](https://github.com/bvaughn/js-search) ⭐ 2,215 | 🐛 8 | 🌐 JavaScript | 📅 2023-05-12 - Feature-rich and customizable: multi-field indices, stop words, custom stemmers and tokenizers. <img align="top" height="24" src="./img/js-search.svg">
...
For non-English words, I only have honorable mentions: [snowball-js](https://github.com/fortnightlabs/snowball-js) ⭐ 102 | 🐛 3 | 🌐 JavaScript | 📅 2011-03-09 is 17 kB with 15 languages, [lunr-languages](https://github.com/MihaiValentin/lunr-languages) ⭐ 458 | 🐛 17 | 🌐 JavaScript | 📅 2026-08-09 supports 30 languages but only works with [lunr,](https://github.com/olivernn/lunr.js) ⭐ 9,201 | 🐛 130 | 🌐 JavaScript | 📅 2024-07-31 the most promising one is [natural](https://github.com/NaturalNode/natural/tree/master/lib/natural/stemmers) ⭐ 10,879 | 🐛 87 | 🌐 JavaScript | 📅 2026-02-22 but it depends on Node.js.
...
* [fuzzy-search](https://github.com/wouterrutgers/fuzzy-search) ⭐ 227 | 🐛 16 | 🌐 JavaScript | 📅 2023-03-14 - With stateful index. <img align="top" height="24" src="./img/fuzzy-search.svg">
...
Suggestions welcome! See [contributing.md](contributing.md), or drop an [issue](https://github.com/thoughtspile/awesome-tiny-js/issues) ⭐ 778 | 🐛 5 | 🌐 JavaScript | 📅 2024-09-24.
