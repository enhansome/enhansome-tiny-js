...
* [preact](https://github.com/preactjs/preact) ⭐ 38,876 | 🐛 39 | 🌐 JavaScript | 📅 2026-09-15 - React-like API (pre-hooks). Cool ecosystem of similarly tiny tools and components. Highly recommended. <img align="top" height="24" src="./img/preact.svg">
...
* [van](https://github.com/vanjs-org/van) ⭐ 4,434 | 🐛 40 | 🌐 JavaScript | 📅 2026-07-16 - vDOM-based framework optimized for no-build setups, <img align="top" height="24" src="./img/vanjs-core.svg">
...
* [arrowjs](https://github.com/justin-schroeder/arrow-js) ⭐ 3,760 | 🐛 7 | 🌐 TypeScript | 📅 2026-07-01 - Tagged templates + reactive data, <img align="top" height="24" src="./img/arrow-jscore.svg">
* [superfine](https://github.com/jorgebucaran/superfine) ⭐ 1,597 | 🐛 5 | 🌐 JavaScript | 📅 2022-08-16 - Hyperapp with state & effect hooks removed, <img align="top" height="24" src="./img/superfine.svg">
...
* [mitt](https://github.com/developit/mitt) ⭐ 11,907 | 🐛 27 | 🌐 TypeScript | 📅 2024-08-14 - Plain event emitter that I use on most projects, <img align="top" height="24" src="./img/mitt.svg">
...
* [zustand](https://github.com/pmndrs/zustand) ⭐ 58,704 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-18 - Simple stores with pleasant actions and selectors. Vanilla <img align="top" height="24" src="./img/zustandvanilla.svg">, React <img align="top" height="24" src="./img/zustand.svg">
* [nanostores](https://github.com/nanostores/nanostores) ⭐ 7,610 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-16 - Modular store with good tree-shaking support, <img align="top" height="24" src="./img/nanostores.svg"> vanilla, + React <img align="top" height="24" src="./img/nanostoresreact.svg"> extra. Supports all the top frameworks.
...
* [storeon](https://github.com/storeon/storeon) ⭐ 1,975 | 🐛 15 | 🌐 JavaScript | 📅 2024-12-10 - Minimal redux-styled store with lots of framework connectors, <img align="top" height="24" src="./img/storeon.svg">. React extra <img align="top" height="24" src="./img/storeonreact.svg"> + Vue, Svelte, Angular.
...
* [exome](https://github.com/marcisbee/exome) ⭐ 283 | 🐛 1 | 🌐 TypeScript | 📅 2026-01-29 - Atomic stores with lots of framework connectors, <img align="top" height="24" src="./img/exome.svg"> + React <img align="top" height="24" src="./img/exomereact.svg"> extra. Supports all the top frameworks.

### Signals

A signal-styled state manager provides observable values (aka *signals*), derived values and effects.

* [@preact/signals](https://github.com/preactjs/signals) ⭐ 4,486 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-15 - The OG signals from preact <img align="top" height="24" src="./img/preactsignals-core.svg"> core, <img align="top" height="24" src="./img/preactsignals-react.svg"> with react integration.
...
* [wouter](https://github.com/molefrog/wouter) ⭐ 7,897 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-14 - Declarative router for React / preact, <img align="top" height="24" src="./img/wouter.svg">, also available as a standalone hook: <img align="top" height="24" src="./img/wouteruse-browser-location.svg">
* [navaid](https://github.com/lukeed/navaid) ⭐ 797 | 🐛 7 | 🌐 JavaScript | 📅 2024-01-20 - History-based observable router, <img align="top" height="24" src="./img/navaid.svg">
...
* [regexparam](https://github.com/lukeed/regexparam) ⭐ 599 | 🐛 9 | 🌐 JavaScript | 📅 2023-12-03 - Convert path to regexp in <img align="top" height="24" src="./img/regexparam.svg">
...
* [wretch](https://github.com/elbywan/wretch) ⭐ 5,173 | 🐛 12 | 🌐 TypeScript | 📅 2026-06-19 - Chainable API with error processing and lots of extra plugins, <img align="top" height="24" src="./img/wretch.svg">
* [redaxios](https://github.com/developit/redaxios) ⭐ 4,878 | 🐛 34 | 🌐 JavaScript | 📅 2023-08-15 - Drop-in axios replacement for modern browsers, <img align="top" height="24" src="./img/redaxios.svg">
...
* [lingui](https://github.com/lingui/js-lingui) ⭐ 5,883 | 🐛 69 | 🌐 TypeScript | 📅 2026-09-18 - Small core with template strings, <img align="top" height="24" src="./img/linguicore.svg">
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,667 | 🐛 1,334 | 🌐 JavaScript | 📅 2026-09-15 - *Almost* moment.js-compatible API, covers most use cases, <img align="top" height="24" src="./img/dayjsesm.svg">
* [date-fns](https://github.com/date-fns/date-fns/) ⭐ 36,644 | 🐛 1,016 | 🌐 TypeScript | 📅 2026-08-30 - Not tiny as a whole, but [most functions](https://bundlephobia.com/package/date-fns) are under 1 kB each (format and parse are quite heavy).

And some more packages that only do formatting:

* [ms](https://github.com/vercel/ms) ⭐ 5,553 | 🐛 38 | 🌐 TypeScript | 📅 2026-05-20 - Parse & format ms durations, e.g. `"1m" <-> 60000`, <img align="top" height="24" src="./img/ms.svg">
...
* [tinytime](https://github.com/aweary/tinytime) ⭐ 1,321 | 🐛 19 | 🌐 JavaScript | 📅 2023-01-12 - Simple date / time formatter: `{h}:{mm} -> 9:33`, <img align="top" height="24" src="./img/tinytime.svg">
...
* [just](https://github.com/angus-c/just) ⭐ 6,201 | 🐛 61 | 🌐 JavaScript | 📅 2024-02-11 - 82 helpers in separate packages [(list).](https://anguscroll.com/just/)
* [remeda](https://github.com/remeda/remeda) ⭐ 5,429 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-18 - 90 tree-shakable helpers [(list).](https://bundlephobia.com/package/remeda)
* [rambda](https://github.com/selfrefactor/rambda) ⭐ 1,757 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-03 - 187 tree-shakable helpers [(list).](https://bundlephobia.com/package/rambda)
* [@fxts/core](https://github.com/marpple/FxTS) ⭐ 1,167 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-29 - 96 tree-shakable helpers. Lazy evaluation support.

Honorable mention: [underscore,](https://github.com/jashkenas/underscore) ⭐ 27,319 | 🐛 54 | 🌐 JavaScript | 📅 2026-09-15 contains many sub-1 kB helpers. It does not tree-shake as well as the libraries above due to codebase structure.
...
* [valibot](https://github.com/fabian-hiller/valibot) ⭐ 9,015 | 🐛 184 | 🌐 TypeScript | 📅 2026-09-19 - Another modular validation library, <img align="top" height="24" src="./img/valibot.svg">
...
* [nanoid](https://github.com/ai/nanoid) ⭐ 26,976 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-16 - Random IDs with larger alphabet, <img align="top" height="24" src="./img/nanoid.svg">
...
* [randomcolor](https://github.com/davidmerfield/randomColor) ⭐ 6,119 | 🐛 16 | 🌐 JavaScript | 📅 2025-12-03 - Attractive random colors with configuration. <img align="top" height="24" src="./img/randomcolor.svg">
* [colord](https://github.com/omgovich/colord) ⭐ 1,890 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-01 - Manipulate colors and convert between spaces, <img align="top" height="24" src="./img/colord.svg">. Extra features come as plugins, 150b to 1.5 kB each.
...
* [alloyfinger](https://github.com/AlloyTeam/AlloyFinger) ⭐ 3,437 | 🐛 77 | 🌐 JavaScript | 📅 2019-01-03 - Pan, swipe, tap, doubletap, longpress, *and* pinch / rotate. My personal favorite. <img align="top" height="24" src="./img/alloyfinger.svg">.
* [tinygesture](https://github.com/sciactive/tinygesture) ⭐ 229 | 🐛 2 | 🌐 TypeScript | 📅 2026-04-04 - Configurable pan, swipe, tap, doubletap, longpress. <img align="top" height="24" src="./img/tinygesture.svg">.
...
* [fuzzyset](https://github.com/Glench/fuzzyset.js) ⭐ 1,376 | 🐛 1 | 🌐 JavaScript | 📅 2021-12-13 - Find misspellings, e.g. missipissi -> Missisipi, <img align="top" height="24" src="./img/fuzzyset.svg"> Commercial usage costs $42.
