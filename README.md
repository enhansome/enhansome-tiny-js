...
* [preact](https://github.com/preactjs/preact) ⭐ 38,813 | 🐛 41 | 🌐 JavaScript | 📅 2026-08-11 - React-like API (pre-hooks). Cool ecosystem of similarly tiny tools and components. Highly recommended. <img align="top" height="24" src="./img/preact.svg">
...
* [hyperapp](https://github.com/jorgebucaran/hyperapp) ⭐ 19,202 | 🐛 14 | 🌐 JavaScript | 📅 2025-03-20 - vDOM framework with pure JS syntax and immutable state, <img align="top" height="24" src="./img/hyperapp.svg">
...
* [van](https://github.com/vanjs-org/van) ⭐ 4,420 | 🐛 40 | 🌐 JavaScript | 📅 2026-07-16 - vDOM-based framework optimized for no-build setups, <img align="top" height="24" src="./img/vanjs-core.svg">
...
* [arrowjs](https://github.com/justin-schroeder/arrow-js) ⭐ 3,719 | 🐛 6 | 🌐 TypeScript | 📅 2026-07-01 - Tagged templates + reactive data, <img align="top" height="24" src="./img/arrow-jscore.svg">
...
* [mitt](https://github.com/developit/mitt) ⭐ 11,900 | 🐛 27 | 🌐 TypeScript | 📅 2024-08-14 - Plain event emitter that I use on most projects, <img align="top" height="24" src="./img/mitt.svg">
* [nanoevents](https://github.com/ai/nanoevents) ⭐ 1,632 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-22 - Nicer unsubscribe API, but no `*` event, <img align="top" height="24" src="./img/nanoevents.svg">
...
* [zustand](https://github.com/pmndrs/zustand) ⭐ 58,555 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-13 - Simple stores with pleasant actions and selectors. Vanilla <img align="top" height="24" src="./img/zustandvanilla.svg">, React <img align="top" height="24" src="./img/zustand.svg">
* [nanostores](https://github.com/nanostores/nanostores) ⭐ 7,554 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-10 - Modular store with good tree-shaking support, <img align="top" height="24" src="./img/nanostores.svg"> vanilla, + React <img align="top" height="24" src="./img/nanostoresreact.svg"> extra. Supports all the top frameworks.
...
* [@preact/signals](https://github.com/preactjs/signals) ⭐ 4,472 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-12 - The OG signals from preact <img align="top" height="24" src="./img/preactsignals-core.svg"> core, <img align="top" height="24" src="./img/preactsignals-react.svg"> with react integration.
...
* [wretch](https://github.com/elbywan/wretch) ⭐ 5,181 | 🐛 10 | 🌐 TypeScript | 📅 2026-06-19 - Chainable API with error processing and lots of extra plugins, <img align="top" height="24" src="./img/wretch.svg">
...
* [gretchen](https://github.com/truework/gretchen) ⭐ 329 | 🐛 17 | 🌐 TypeScript | 📅 2023-10-05 - Chainable API with type-safe errors, <img align="top" height="24" src="./img/gretchen.svg">

If for some reason you still need a fetch polyfill, try this one:

* [unfetch](https://github.com/developit/unfetch) ⭐ 5,702 | 🐛 30 | 🌐 JavaScript | 📅 2023-07-23 - Loose fetch polyfill, <img align="top" height="24" src="./img/unfetch.svg">

## I18N

A map of strings might seem enough to translate an app, but these tools also handle interpolation and some extra goodies:

* [lingui](https://github.com/lingui/js-lingui) ⭐ 5,844 | 🐛 64 | 🌐 TypeScript | 📅 2026-08-03 - Small core with template strings, <img align="top" height="24" src="./img/linguicore.svg">
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,669 | 🐛 1,294 | 🌐 JavaScript | 📅 2026-06-30 - *Almost* moment.js-compatible API, covers most use cases, <img align="top" height="24" src="./img/dayjsesm.svg">
* [date-fns](https://github.com/date-fns/date-fns/) ⭐ 36,622 | 🐛 983 | 🌐 TypeScript | 📅 2026-08-10 - Not tiny as a whole, but [most functions](https://bundlephobia.com/package/date-fns) are under 1 kB each (format and parse are quite heavy).
...
* [just](https://github.com/angus-c/just) ⭐ 6,204 | 🐛 58 | 🌐 JavaScript | 📅 2024-02-11 - 82 helpers in separate packages [(list).](https://anguscroll.com/just/)
* [remeda](https://github.com/remeda/remeda) ⭐ 5,412 | 🐛 31 | 🌐 TypeScript | 📅 2026-08-12 - 90 tree-shakable helpers [(list).](https://bundlephobia.com/package/remeda)
* [rambda](https://github.com/selfrefactor/rambda) ⭐ 1,755 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-05 - 187 tree-shakable helpers [(list).](https://bundlephobia.com/package/rambda)
* [@fxts/core](https://github.com/marpple/FxTS) ⭐ 1,165 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-08 - 96 tree-shakable helpers. Lazy evaluation support.

Honorable mention: [underscore,](https://github.com/jashkenas/underscore) ⭐ 27,340 | 🐛 52 | 🌐 JavaScript | 📅 2026-08-12 contains many sub-1 kB helpers. It does not tree-shake as well as the libraries above due to codebase structure.
...
* [valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,928 | 🐛 168 | 🌐 TypeScript | 📅 2026-08-13 - Another modular validation library, <img align="top" height="24" src="./img/valibot.svg">
...
* [nanoid](https://github.com/ai/nanoid) ⭐ 26,929 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-10 - Random IDs with larger alphabet, <img align="top" height="24" src="./img/nanoid.svg">
...
* [randomcolor](https://github.com/davidmerfield/randomColor) ⭐ 6,126 | 🐛 16 | 🌐 JavaScript | 📅 2025-12-03 - Attractive random colors with configuration. <img align="top" height="24" src="./img/randomcolor.svg">
* [colord](https://github.com/omgovich/colord) ⭐ 1,878 | 🐛 35 | 🌐 TypeScript | 📅 2026-05-23 - Manipulate colors and convert between spaces, <img align="top" height="24" src="./img/colord.svg">. Extra features come as plugins, 150b to 1.5 kB each.
...
* [libsearch](https://github.com/thesephist/libsearch) ⭐ 389 | 🐛 1 | 🌐 JavaScript | 📅 2022-07-21 - Index-free search (slower, but easier to use) with sane ordering <img align="top" height="24" src="./img/libsearch.svg">
...
For non-English words, I only have honorable mentions: [snowball-js](https://github.com/fortnightlabs/snowball-js) ⭐ 102 | 🐛 3 | 🌐 JavaScript | 📅 2011-03-09 is 17 kB with 15 languages, [lunr-languages](https://github.com/MihaiValentin/lunr-languages) ⭐ 457 | 🐛 17 | 🌐 JavaScript | 📅 2026-08-09 supports 30 languages but only works with [lunr,](https://github.com/olivernn/lunr.js) ⭐ 9,200 | 🐛 130 | 🌐 JavaScript | 📅 2024-07-31 the most promising one is [natural](https://github.com/NaturalNode/natural/tree/master/lib/natural/stemmers) ⭐ 10,878 | 🐛 86 | 🌐 JavaScript | 📅 2026-02-22 but it depends on Node.js.
