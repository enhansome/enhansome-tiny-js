...
* [preact](https://github.com/preactjs/preact) ⭐ 38,849 | 🐛 39 | 🌐 JavaScript | 📅 2026-09-04 - React-like API (pre-hooks). Cool ecosystem of similarly tiny tools and components. Highly recommended. <img align="top" height="24" src="./img/preact.svg">
...
* [nanostores](https://github.com/nanostores/nanostores) ⭐ 7,596 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-03 - Modular store with good tree-shaking support, <img align="top" height="24" src="./img/nanostores.svg"> vanilla, + React <img align="top" height="24" src="./img/nanostoresreact.svg"> extra. Supports all the top frameworks.
...
* [@preact/signals](https://github.com/preactjs/signals) ⭐ 4,479 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-04 - The OG signals from preact <img align="top" height="24" src="./img/preactsignals-core.svg"> core, <img align="top" height="24" src="./img/preactsignals-react.svg"> with react integration.
...
* [wouter](https://github.com/molefrog/wouter) ⭐ 7,875 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-21 - Declarative router for React / preact, <img align="top" height="24" src="./img/wouter.svg">, also available as a standalone hook: <img align="top" height="24" src="./img/wouteruse-browser-location.svg">
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,664 | 🐛 1,321 | 🌐 JavaScript | 📅 2026-09-01 - *Almost* moment.js-compatible API, covers most use cases, <img align="top" height="24" src="./img/dayjsesm.svg">
* [date-fns](https://github.com/date-fns/date-fns/) ⭐ 36,647 | 🐛 1,005 | 🌐 TypeScript | 📅 2026-08-30 - Not tiny as a whole, but [most functions](https://bundlephobia.com/package/date-fns) are under 1 kB each (format and parse are quite heavy).
...
* [remeda](https://github.com/remeda/remeda) ⭐ 5,426 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-03 - 90 tree-shakable helpers [(list).](https://bundlephobia.com/package/remeda)
* [rambda](https://github.com/selfrefactor/rambda) ⭐ 1,754 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-03 - 187 tree-shakable helpers [(list).](https://bundlephobia.com/package/rambda)
* [@fxts/core](https://github.com/marpple/FxTS) ⭐ 1,169 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-29 - 96 tree-shakable helpers. Lazy evaluation support.

Honorable mention: [underscore,](https://github.com/jashkenas/underscore) ⭐ 27,325 | 🐛 52 | 🌐 JavaScript | 📅 2026-08-12 contains many sub-1 kB helpers. It does not tree-shake as well as the libraries above due to codebase structure.
...
* [valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,975 | 🐛 182 | 🌐 TypeScript | 📅 2026-09-03 - Another modular validation library, <img align="top" height="24" src="./img/valibot.svg">
...
* [nanoid](https://github.com/ai/nanoid) ⭐ 26,962 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-01 - Random IDs with larger alphabet, <img align="top" height="24" src="./img/nanoid.svg">
...
For non-English words, I only have honorable mentions: [snowball-js](https://github.com/fortnightlabs/snowball-js) ⭐ 102 | 🐛 3 | 🌐 JavaScript | 📅 2011-03-09 is 17 kB with 15 languages, [lunr-languages](https://github.com/MihaiValentin/lunr-languages) ⭐ 458 | 🐛 17 | 🌐 JavaScript | 📅 2026-08-09 supports 30 languages but only works with [lunr,](https://github.com/olivernn/lunr.js) ⭐ 9,203 | 🐛 130 | 🌐 JavaScript | 📅 2024-07-31 the most promising one is [natural](https://github.com/NaturalNode/natural/tree/master/lib/natural/stemmers) ⭐ 10,881 | 🐛 87 | 🌐 JavaScript | 📅 2026-02-22 but it depends on Node.js.
