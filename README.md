...
* [preact](https://github.com/preactjs/preact) ⭐ 38,855 | 🐛 41 | 🌐 JavaScript | 📅 2026-09-07 - React-like API (pre-hooks). Cool ecosystem of similarly tiny tools and components. Highly recommended. <img align="top" height="24" src="./img/preact.svg">
...
* [van](https://github.com/vanjs-org/van) ⭐ 4,427 | 🐛 40 | 🌐 JavaScript | 📅 2026-07-16 - vDOM-based framework optimized for no-build setups, <img align="top" height="24" src="./img/vanjs-core.svg">
...
* [arrowjs](https://github.com/justin-schroeder/arrow-js) ⭐ 3,733 | 🐛 6 | 🌐 TypeScript | 📅 2026-07-01 - Tagged templates + reactive data, <img align="top" height="24" src="./img/arrow-jscore.svg">
...
* [umbrella](https://github.com/franciscop/umbrella) ⭐ 2,345 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-02 - jQuery-style DOM manipulation library, <img align="top" height="24" src="./img/umbrellajs.svg">
...
* [zustand](https://github.com/pmndrs/zustand) ⭐ 58,651 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-07 - Simple stores with pleasant actions and selectors. Vanilla <img align="top" height="24" src="./img/zustandvanilla.svg">, React <img align="top" height="24" src="./img/zustand.svg">
* [nanostores](https://github.com/nanostores/nanostores) ⭐ 7,597 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-06 - Modular store with good tree-shaking support, <img align="top" height="24" src="./img/nanostores.svg"> vanilla, + React <img align="top" height="24" src="./img/nanostoresreact.svg"> extra. Supports all the top frameworks.
...
* [@preact/signals](https://github.com/preactjs/signals) ⭐ 4,481 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-04 - The OG signals from preact <img align="top" height="24" src="./img/preactsignals-core.svg"> core, <img align="top" height="24" src="./img/preactsignals-react.svg"> with react integration.
...
* [flyd](https://github.com/paldepind/flyd) ⭐ 1,566 | 🐛 55 | 🌐 JavaScript | 📅 2024-02-05 - Rx-styled event streams, <img align="top" height="24" src="./img/flyd.svg">

## Routers and URL Utils

Do stuff on URL / history changes, with path matching and parsing:

* [wouter](https://github.com/molefrog/wouter) ⭐ 7,876 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-05 - Declarative router for React / preact, <img align="top" height="24" src="./img/wouter.svg">, also available as a standalone hook: <img align="top" height="24" src="./img/wouteruse-browser-location.svg">
...
* [wretch](https://github.com/elbywan/wretch) ⭐ 5,175 | 🐛 10 | 🌐 TypeScript | 📅 2026-06-19 - Chainable API with error processing and lots of extra plugins, <img align="top" height="24" src="./img/wretch.svg">
...
* [unfetch](https://github.com/developit/unfetch) ⭐ 5,699 | 🐛 30 | 🌐 JavaScript | 📅 2023-07-23 - Loose fetch polyfill, <img align="top" height="24" src="./img/unfetch.svg">

## I18N

A map of strings might seem enough to translate an app, but these tools also handle interpolation and some extra goodies:

* [lingui](https://github.com/lingui/js-lingui) ⭐ 5,873 | 🐛 69 | 🌐 TypeScript | 📅 2026-09-07 - Small core with template strings, <img align="top" height="24" src="./img/linguicore.svg">
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,663 | 🐛 1,325 | 🌐 JavaScript | 📅 2026-09-01 - *Almost* moment.js-compatible API, covers most use cases, <img align="top" height="24" src="./img/dayjsesm.svg">
* [date-fns](https://github.com/date-fns/date-fns/) ⭐ 36,649 | 🐛 1,005 | 🌐 TypeScript | 📅 2026-08-30 - Not tiny as a whole, but [most functions](https://bundlephobia.com/package/date-fns) are under 1 kB each (format and parse are quite heavy).
...
* [remeda](https://github.com/remeda/remeda) ⭐ 5,425 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-07 - 90 tree-shakable helpers [(list).](https://bundlephobia.com/package/remeda)
...
Honorable mention: [underscore,](https://github.com/jashkenas/underscore) ⭐ 27,324 | 🐛 52 | 🌐 JavaScript | 📅 2026-08-12 contains many sub-1 kB helpers. It does not tree-shake as well as the libraries above due to codebase structure.
...
* [valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,977 | 🐛 179 | 🌐 TypeScript | 📅 2026-09-07 - Another modular validation library, <img align="top" height="24" src="./img/valibot.svg">
* [superstruct](https://github.com/ianstormtaylor/superstruct) ⭐ 7,131 | 🐛 104 | 🌐 TypeScript | 📅 2024-10-01 - The most popular modular validation library with good tree-shaking, <img align="top" height="24" src="./img/superstruct.svg">
...
* [nanoid](https://github.com/ai/nanoid) ⭐ 26,961 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-01 - Random IDs with larger alphabet, <img align="top" height="24" src="./img/nanoid.svg">
...
* [colord](https://github.com/omgovich/colord) ⭐ 1,886 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-01 - Manipulate colors and convert between spaces, <img align="top" height="24" src="./img/colord.svg">. Extra features come as plugins, 150b to 1.5 kB each.
...
Honorable mentions: [any-touch](https://github.com/any86/any-touch) ⭐ 1,245 | 🐛 18 | 🌐 TypeScript | 📅 2026-01-09 attempts a modular approach to gesture detection, but the core is around 2 kB without any gesture recognizers. [rc-gesture,](https://github.com/react-component/gesture) ⭐ 104 | 🐛 15 | 🌐 TypeScript | 📅 2021-07-27 used in ant design system, could be the only react component on the list, but babel-runtime / corejs polyfills hard-wired into the build push the \~2.5 kB size to over 10 kB.
...
For non-English words, I only have honorable mentions: [snowball-js](https://github.com/fortnightlabs/snowball-js) ⭐ 102 | 🐛 3 | 🌐 JavaScript | 📅 2011-03-09 is 17 kB with 15 languages, [lunr-languages](https://github.com/MihaiValentin/lunr-languages) ⭐ 458 | 🐛 17 | 🌐 JavaScript | 📅 2026-08-09 supports 30 languages but only works with [lunr,](https://github.com/olivernn/lunr.js) ⭐ 9,202 | 🐛 130 | 🌐 JavaScript | 📅 2024-07-31 the most promising one is [natural](https://github.com/NaturalNode/natural/tree/master/lib/natural/stemmers) ⭐ 10,880 | 🐛 86 | 🌐 JavaScript | 📅 2026-02-22 but it depends on Node.js.
...
* [fuzzysearch](https://github.com/bevacqua/fuzzysearch) ⭐ 2,741 | 🐛 5 | 🌐 JavaScript | 📅 2023-05-31 -  One string at a time, does not compute score / rank. <img align="top" height="24" src="./img/fuzzysearch.svg">
