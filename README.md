...
* [preact](https://github.com/preactjs/preact) ⭐ 38,829 | 🐛 39 | 🌐 JavaScript | 📅 2026-08-21 - React-like API (pre-hooks). Cool ecosystem of similarly tiny tools and components. Highly recommended. <img align="top" height="24" src="./img/preact.svg">
...
* [arrowjs](https://github.com/justin-schroeder/arrow-js) ⭐ 3,724 | 🐛 6 | 🌐 TypeScript | 📅 2026-07-01 - Tagged templates + reactive data, <img align="top" height="24" src="./img/arrow-jscore.svg">
...
* [zustand](https://github.com/pmndrs/zustand) ⭐ 58,595 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-19 - Simple stores with pleasant actions and selectors. Vanilla <img align="top" height="24" src="./img/zustandvanilla.svg">, React <img align="top" height="24" src="./img/zustand.svg">
* [nanostores](https://github.com/nanostores/nanostores) ⭐ 7,571 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-20 - Modular store with good tree-shaking support, <img align="top" height="24" src="./img/nanostores.svg"> vanilla, + React <img align="top" height="24" src="./img/nanostoresreact.svg"> extra. Supports all the top frameworks.
...
* [lingui](https://github.com/lingui/js-lingui) ⭐ 5,853 | 🐛 67 | 🌐 TypeScript | 📅 2026-08-14 - Small core with template strings, <img align="top" height="24" src="./img/linguicore.svg">
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,665 | 🐛 1,298 | 🌐 JavaScript | 📅 2026-08-18 - *Almost* moment.js-compatible API, covers most use cases, <img align="top" height="24" src="./img/dayjsesm.svg">
* [date-fns](https://github.com/date-fns/date-fns/) ⭐ 36,637 | 🐛 995 | 🌐 TypeScript | 📅 2026-08-10 - Not tiny as a whole, but [most functions](https://bundlephobia.com/package/date-fns) are under 1 kB each (format and parse are quite heavy).

And some more packages that only do formatting:

* [ms](https://github.com/vercel/ms) ⭐ 5,543 | 🐛 37 | 🌐 TypeScript | 📅 2026-05-20 - Parse & format ms durations, e.g. `"1m" <-> 60000`, <img align="top" height="24" src="./img/ms.svg">
...
* [remeda](https://github.com/remeda/remeda) ⭐ 5,415 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-19 - 90 tree-shakable helpers [(list).](https://bundlephobia.com/package/remeda)
...
Honorable mention: [underscore,](https://github.com/jashkenas/underscore) ⭐ 27,333 | 🐛 52 | 🌐 JavaScript | 📅 2026-08-12 contains many sub-1 kB helpers. It does not tree-shake as well as the libraries above due to codebase structure.
...
* [valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,950 | 🐛 171 | 🌐 TypeScript | 📅 2026-08-22 - Another modular validation library, <img align="top" height="24" src="./img/valibot.svg">
* [superstruct](https://github.com/ianstormtaylor/superstruct) ⭐ 7,135 | 🐛 104 | 🌐 TypeScript | 📅 2024-10-01 - The most popular modular validation library with good tree-shaking, <img align="top" height="24" src="./img/superstruct.svg">
...
* [colord](https://github.com/omgovich/colord) ⭐ 1,885 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-20 - Manipulate colors and convert between spaces, <img align="top" height="24" src="./img/colord.svg">. Extra features come as plugins, 150b to 1.5 kB each.
