...
* [preact](https://github.com/preactjs/preact) ⭐ 38,860 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-10 - React-like API (pre-hooks). Cool ecosystem of similarly tiny tools and components. Highly recommended. <img align="top" height="24" src="./img/preact.svg">
...
* [arrowjs](https://github.com/justin-schroeder/arrow-js) ⭐ 3,756 | 🐛 7 | 🌐 TypeScript | 📅 2026-07-01 - Tagged templates + reactive data, <img align="top" height="24" src="./img/arrow-jscore.svg">
...
* [zustand](https://github.com/pmndrs/zustand) ⭐ 58,673 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-11 - Simple stores with pleasant actions and selectors. Vanilla <img align="top" height="24" src="./img/zustandvanilla.svg">, React <img align="top" height="24" src="./img/zustand.svg">
* [nanostores](https://github.com/nanostores/nanostores) ⭐ 7,602 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-08 - Modular store with good tree-shaking support, <img align="top" height="24" src="./img/nanostores.svg"> vanilla, + React <img align="top" height="24" src="./img/nanostoresreact.svg"> extra. Supports all the top frameworks.
...
* [wouter](https://github.com/molefrog/wouter) ⭐ 7,887 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-05 - Declarative router for React / preact, <img align="top" height="24" src="./img/wouter.svg">, also available as a standalone hook: <img align="top" height="24" src="./img/wouteruse-browser-location.svg">
...
* [lingui](https://github.com/lingui/js-lingui) ⭐ 5,876 | 🐛 66 | 🌐 TypeScript | 📅 2026-09-11 - Small core with template strings, <img align="top" height="24" src="./img/linguicore.svg">
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,665 | 🐛 1,325 | 🌐 JavaScript | 📅 2026-09-09 - *Almost* moment.js-compatible API, covers most use cases, <img align="top" height="24" src="./img/dayjsesm.svg">
* [date-fns](https://github.com/date-fns/date-fns/) ⭐ 36,646 | 🐛 1,008 | 🌐 TypeScript | 📅 2026-08-30 - Not tiny as a whole, but [most functions](https://bundlephobia.com/package/date-fns) are under 1 kB each (format and parse are quite heavy).
...
* [just](https://github.com/angus-c/just) ⭐ 6,200 | 🐛 60 | 🌐 JavaScript | 📅 2024-02-11 - 82 helpers in separate packages [(list).](https://anguscroll.com/just/)
* [remeda](https://github.com/remeda/remeda) ⭐ 5,427 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-11 - 90 tree-shakable helpers [(list).](https://bundlephobia.com/package/remeda)
...
Honorable mention: [underscore,](https://github.com/jashkenas/underscore) ⭐ 27,322 | 🐛 52 | 🌐 JavaScript | 📅 2026-08-12 contains many sub-1 kB helpers. It does not tree-shake as well as the libraries above due to codebase structure.
...
* [valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,999 | 🐛 174 | 🌐 TypeScript | 📅 2026-09-12 - Another modular validation library, <img align="top" height="24" src="./img/valibot.svg">
...
* [nanoid](https://github.com/ai/nanoid) ⭐ 26,965 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-10 - Random IDs with larger alphabet, <img align="top" height="24" src="./img/nanoid.svg">
...
* [colord](https://github.com/omgovich/colord) ⭐ 1,887 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-01 - Manipulate colors and convert between spaces, <img align="top" height="24" src="./img/colord.svg">. Extra features come as plugins, 150b to 1.5 kB each.
...
For non-English words, I only have honorable mentions: [snowball-js](https://github.com/fortnightlabs/snowball-js) ⭐ 102 | 🐛 3 | 🌐 JavaScript | 📅 2011-03-09 is 17 kB with 15 languages, [lunr-languages](https://github.com/MihaiValentin/lunr-languages) ⭐ 458 | 🐛 17 | 🌐 JavaScript | 📅 2026-08-09 supports 30 languages but only works with [lunr,](https://github.com/olivernn/lunr.js) ⭐ 9,200 | 🐛 130 | 🌐 JavaScript | 📅 2024-07-31 the most promising one is [natural](https://github.com/NaturalNode/natural/tree/master/lib/natural/stemmers) ⭐ 10,880 | 🐛 88 | 🌐 JavaScript | 📅 2026-02-22 but it depends on Node.js.
