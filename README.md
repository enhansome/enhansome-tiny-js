...
* [preact](https://github.com/preactjs/preact) ⭐ 38,881 | 🐛 39 | 🌐 JavaScript | 📅 2026-09-15 - React-like API (pre-hooks). Cool ecosystem of similarly tiny tools and components. Highly recommended. <img align="top" height="24" src="./img/preact.svg">
...
* [mitt](https://github.com/developit/mitt) ⭐ 11,909 | 🐛 27 | 🌐 TypeScript | 📅 2024-08-14 - Plain event emitter that I use on most projects, <img align="top" height="24" src="./img/mitt.svg">
...
* [zustand](https://github.com/pmndrs/zustand) ⭐ 58,726 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-22 - Simple stores with pleasant actions and selectors. Vanilla <img align="top" height="24" src="./img/zustandvanilla.svg">, React <img align="top" height="24" src="./img/zustand.svg">
* [nanostores](https://github.com/nanostores/nanostores) ⭐ 7,614 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-16 - Modular store with good tree-shaking support, <img align="top" height="24" src="./img/nanostores.svg"> vanilla, + React <img align="top" height="24" src="./img/nanostoresreact.svg"> extra. Supports all the top frameworks.
...
* [@preact/signals](https://github.com/preactjs/signals) ⭐ 4,487 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-15 - The OG signals from preact <img align="top" height="24" src="./img/preactsignals-core.svg"> core, <img align="top" height="24" src="./img/preactsignals-react.svg"> with react integration.
...
* [wouter](https://github.com/molefrog/wouter) ⭐ 7,896 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-14 - Declarative router for React / preact, <img align="top" height="24" src="./img/wouter.svg">, also available as a standalone hook: <img align="top" height="24" src="./img/wouteruse-browser-location.svg">
...
* [wretch](https://github.com/elbywan/wretch) ⭐ 5,176 | 🐛 12 | 🌐 TypeScript | 📅 2026-06-19 - Chainable API with error processing and lots of extra plugins, <img align="top" height="24" src="./img/wretch.svg">
...
* [lingui](https://github.com/lingui/js-lingui) ⭐ 5,890 | 🐛 64 | 🌐 TypeScript | 📅 2026-09-22 - Small core with template strings, <img align="top" height="24" src="./img/linguicore.svg">
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,667 | 🐛 1,335 | 🌐 JavaScript | 📅 2026-09-15 - *Almost* moment.js-compatible API, covers most use cases, <img align="top" height="24" src="./img/dayjsesm.svg">
* [date-fns](https://github.com/date-fns/date-fns/) ⭐ 36,645 | 🐛 1,017 | 🌐 TypeScript | 📅 2026-09-22 - Not tiny as a whole, but [most functions](https://bundlephobia.com/package/date-fns) are under 1 kB each (format and parse are quite heavy).
...
* [tinydate](https://github.com/lukeed/tinydate) ⭐ 1,067 | 🐛 3 | 🌐 JavaScript | 📅 2024-01-20 - Date / time formatter, only supports padded numeric output (`September -> 09`), <img align="top" height="24" src="./img/tinydate.svg">
...
Honorable mention: [underscore,](https://github.com/jashkenas/underscore) ⭐ 27,320 | 🐛 53 | 🌐 JavaScript | 📅 2026-09-22 contains many sub-1 kB helpers. It does not tree-shake as well as the libraries above due to codebase structure.
...
* [valibot](https://github.com/fabian-hiller/valibot) ⭐ 9,022 | 🐛 182 | 🌐 TypeScript | 📅 2026-09-22 - Another modular validation library, <img align="top" height="24" src="./img/valibot.svg">
...
* [nanoid](https://github.com/ai/nanoid) ⭐ 26,983 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-16 - Random IDs with larger alphabet, <img align="top" height="24" src="./img/nanoid.svg">
