...
* [preact](https://github.com/preactjs/preact) ⭐ 38,875 | 🐛 39 | 🌐 JavaScript | 📅 2026-09-15 - React-like API (pre-hooks). Cool ecosystem of similarly tiny tools and components. Highly recommended. <img align="top" height="24" src="./img/preact.svg">
...
* [van](https://github.com/vanjs-org/van) ⭐ 4,435 | 🐛 40 | 🌐 JavaScript | 📅 2026-07-16 - vDOM-based framework optimized for no-build setups, <img align="top" height="24" src="./img/vanjs-core.svg">
...
* [arrowjs](https://github.com/justin-schroeder/arrow-js) ⭐ 3,761 | 🐛 7 | 🌐 TypeScript | 📅 2026-07-01 - Tagged templates + reactive data, <img align="top" height="24" src="./img/arrow-jscore.svg">
...
* [zustand](https://github.com/pmndrs/zustand) ⭐ 58,708 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-18 - Simple stores with pleasant actions and selectors. Vanilla <img align="top" height="24" src="./img/zustandvanilla.svg">, React <img align="top" height="24" src="./img/zustand.svg">
...
* [wouter](https://github.com/molefrog/wouter) ⭐ 7,898 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-14 - Declarative router for React / preact, <img align="top" height="24" src="./img/wouter.svg">, also available as a standalone hook: <img align="top" height="24" src="./img/wouteruse-browser-location.svg">
...
* [lingui](https://github.com/lingui/js-lingui) ⭐ 5,886 | 🐛 70 | 🌐 TypeScript | 📅 2026-09-18 - Small core with template strings, <img align="top" height="24" src="./img/linguicore.svg">
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,666 | 🐛 1,334 | 🌐 JavaScript | 📅 2026-09-15 - *Almost* moment.js-compatible API, covers most use cases, <img align="top" height="24" src="./img/dayjsesm.svg">
* [date-fns](https://github.com/date-fns/date-fns/) ⭐ 36,644 | 🐛 1,017 | 🌐 TypeScript | 📅 2026-08-30 - Not tiny as a whole, but [most functions](https://bundlephobia.com/package/date-fns) are under 1 kB each (format and parse are quite heavy).
...
Honorable mention: [underscore,](https://github.com/jashkenas/underscore) ⭐ 27,318 | 🐛 54 | 🌐 JavaScript | 📅 2026-09-15 contains many sub-1 kB helpers. It does not tree-shake as well as the libraries above due to codebase structure.
...
* [valibot](https://github.com/fabian-hiller/valibot) ⭐ 9,015 | 🐛 185 | 🌐 TypeScript | 📅 2026-09-20 - Another modular validation library, <img align="top" height="24" src="./img/valibot.svg">
...
* [nanoid](https://github.com/ai/nanoid) ⭐ 26,978 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-16 - Random IDs with larger alphabet, <img align="top" height="24" src="./img/nanoid.svg">
